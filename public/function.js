...
function roll_trait(){ 
    ...
    if(random >= 1 && random <= 2997){ //Superior - 29.97% chance    
        ...
        if(random2 < 3){
            ...
            GFG_Fun("img/trait/trait_superior" );
        } 
        else{
            document.getElementById("trait").classList.add("epic");   
            GFG_Fun("img/trait/trait_superior_3" );
        }
    }
        ...
        if(random2 < 3){
            document.getElementById("trait").classList.add("rare");  
            GFG_Fun("img/trait/trait_nimble" );
        } 
        else{
            document.getElementById("trait").classList.add("epic");   
            GFG_Fun("img/trait/trait_nimble_3" );
        }   
    }
        ...
        if(random2 < 3){
            document.getElementById("trait").classList.add("rare");  
            GFG_Fun("img/trait/trait_range" );
        } 
        else{
            document.getElementById("trait").classList.add("epic");   
            GFG_Fun("img/trait/trait_range_3" );
        } 
    }
